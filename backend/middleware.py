...
PUBLIC_PATHS = {"/", "/api/auth/register", "/api/auth/login", "/api/auth/social", "/api/check-zone", "/api/categories", "/api/products", "/api/places/search", "/api/combo-packs", "/api/delivery-fee", "/api/offers", "/docs", "/openapi.json", "/redoc"}
