...
import '../location/services/delivery_zone_service.dart';
import '../../core/models/cart_model.dart';
import '../../core/models/grocery_product.dart';
...
import '../location/pages/map_picker_page.dart';
import '../addresses/addresses_page.dart';
import '../payment/payments_page.dart';
import '../profile/suggest_products_page.dart';
    ...
    return source
        .map(
          (p) => _ProductData(
            ...
            stock: (p['stock'] ?? 0) is int ? (p['stock'] ?? 0) : int.tryParse('${p['stock']}') ?? 0,
