...
class _ProductDetailPageState extends State<ProductDetailPage> {
  ...
  Widget _fallbackImage() {
    return Container(
      ...
      child: Text(widget.name.isNotEmpty ? widget.name[0].toUpperCase() : '?', style: TextStyle(fontSize: 64, fontWeight: FontWeight.bold, color: widget.color.withAlpha(180))),
    );
  }
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          child: const Text('In Stock', style: TextStyle(color: Colors.white, fontSize: 11, fontWeight: FontWeight.w600)),
                        ),
                    ...
                    Positioned(
                      ...
                      child: Row(
                        children: List.generate(displayImages.length, (i) => AnimatedContainer(
                          ...
                          height: 6,
                          decoration: BoxDecoration(
                            color: _currentImage == i ? Colors.white : Colors.white.withAlpha(100),
                    ...
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: isFav ? Colors.red.withAlpha(10) : Colors.grey.withAlpha(10),
                        ...
                        child: Row(
                          children: [
                            GestureDetector(
                              ...
                              child: Container(width: 32, height: 32, decoration: BoxDecoration(color: widget.color, borderRadius: BorderRadius.circular(8)), child: const Icon(Icons.remove, color: Colors.white, size: 18)),
                            ),
                            SizedBox(
                              width: 48,
                              child: Center(child: Text('$_qty', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold))),
                            ),
                            GestureDetector(
                              onTap: () => setState(() => _qty++),
                              child: Container(width: 32, height: 32, decoration: BoxDecoration(color: widget.color, borderRadius: BorderRadius.circular(8)), child: const Icon(Icons.add, color: Colors.white, size: 18)),
                            ),
                          ],
                        ),
                      ),
          ...
          child: SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: widget.inCart ? Colors.green.shade100 : widget.color,
